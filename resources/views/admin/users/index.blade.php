    ...
    <div class="container px-6 mx-auto">
        ...
        <div class="my-6">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mt-4">
                ...
                <!-- Tambah User Button -->
                <button type="button"
                        onclick="window.location.href='{{ route('elearning.admin.users.create') }}'"
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center" style="gap: 12px;">
                                    ...
                                    <button class="flex items-center justify-center w-8 h-8 bg-blue-500 text-white rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 transition-colors duration-150" 
                                            aria-label="Edit"
                                            onclick="window.location.href='{{ route('elearning.admin.users.edit', $user['id']) }}'">
                                    ...
                                    <form action="{{ route('elearning.admin.users.destroy', $user['id']) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus user ini?');" class="inline-block m-0">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
