    ...
    <div class="container px-6 mx-auto">
        ...
        <div class="my-6">
            <div class="flex items-start justify-between">
                <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200">Edit Voucher</h2>
        ...
        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-md bg-white dark:bg-gray-800">
            <form id="voucherForm" action="{{ route('elearning.admin.vouchers.update', $voucher['id']) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="px-6 py-6 space-y-6">
                    ...
                    <div>
                        ...
                        <select name="status" id="status" required
                            ...
                            <option value="Non-Aktif" {{ $voucher['status'] === 'Non-Aktif' ? 'selected' : '' }}>Non-Aktif</option>
                        </select>
                    </div>
