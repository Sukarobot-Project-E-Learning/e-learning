    ...
    <div class="container px-6 mx-auto">
        ...
        <div class="my-6">
            <div class="flex items-start justify-between">
                <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200">Edit Kategori Program</h2>
        ...
        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-md bg-white dark:bg-gray-800">
            <form id="categoryForm" action="{{ route('admin.program-categories.update', $category->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="px-6 py-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="slug" 
                               value="{{ $category->slug }}"
                               readonly
                               class="block w-full px-4 py-3 text-sm text-gray-500 bg-gray-100 border border-gray-300 rounded-lg dark:border-gray-600 dark:bg-gray-700 dark:text-gray-400 cursor-not-allowed">
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                            Slug akan otomatis diupdate saat nama kategori diubah
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4"
                                  ...
                                  class="block w-full px-4 py-3 text-sm text-gray-700 placeholder-gray-400 bg-white border border-gray-300 rounded-lg focus:border-purple-400 focus:outline-none focus:ring focus:ring-purple-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:focus:border-purple-300 dark:placeholder-gray-500">{{ old('description', $category->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
