...
@section('content')
<div class="container px-6 mx-auto overflow-x-hidden max-w-full" x-data="certificateTable()">
                    ...
                    <template x-for="(template, index) in templates" :key="template.id">
                        <tr class="hover:bg-orange-50 dark:hover:bg-gray-700 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 text-sm">
                                <span :class="template.certificates_count > 0 ? 'text-green-700 bg-green-100 dark:bg-green-700 dark:text-green-100' : 'text-gray-700 bg-gray-100 dark:bg-gray-700 dark:text-gray-300'" class="px-1 py-0 text-xs font-semibold rounded-full" x-text="template.certificates_count + ' sertifikat'"></span>
                            </td>
