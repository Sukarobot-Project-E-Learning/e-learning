...
@section('content')
    ...
    <div class="container px-6 mx-auto">
        ...
        <div class="my-6">
            <div class="flex items-start justify-between">
                ...
                <div class="flex flex-col items-end" style="gap: 16px;">
                    <a href="{{ route('elearning.admin.programs.index') }}"
        ...
        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-md bg-white dark:bg-gray-800">
            <form id="programForm" action="{{ route('elearning.admin.programs.update', $program->id ?? 1) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="px-6 py-6 space-y-6">
                    ...
                    <div>
                        ...
                        <select name="category" id="category" required
                            ...
                            <option value="pelatihan" {{ (isset($program) && $program->category == 'pelatihan') ? 'selected' : '' }}>Pelatihan</option>
                            <option value="sertifikasi" {{ (isset($program) && $program->category == 'sertifikasi') ? 'selected' : '' }}>Sertifikasi</option>
                            <option value="training" {{ (isset($program) && $program->category == 'training') ? 'selected' : '' }}>Training</option>
                            <option value="event" {{ (isset($program) && $program->category == 'event') ? 'selected' : '' }}>Event</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4" required
                                  ...
                                  class="block w-full px-4 py-3 text-sm text-gray-700 placeholder-gray-400 bg-white border border-gray-300 rounded-lg focus:border-purple-400 focus:outline-none focus:ring focus:ring-purple-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:focus:border-purple-300 dark:placeholder-gray-500">{{ $program->description ?? '' }}</textarea>
                    </div>

                    <!-- Keterangan Harga -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" for="price_note">
                            Keterangan Harga <span class="text-red-500">*</span>
                        </label>
                        <input type="text" name="price_note" id="price_note" required
                               value="{{ $program->price_note ?? '' }}"
                    ...
                    <div>
                        ...
                        <select name="type" id="type" required
                            ...
                            <option value="offline" {{ (isset($program) && $program->type == 'offline') ? 'selected' : '' }}>Offline</option>
                            <option value="online" {{ (isset($program) && $program->type == 'online') ? 'selected' : '' }}>Online</option>
                            <option value="video" {{ (isset($program) && $program->type == 'video') ? 'selected' : '' }}>Video</option>
                        </select>
                    </div>

                    <!-- Kursus -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" for="course">
                            Kursus
                        </label>
                    ...
                    <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea name="full_address" id="full_address" rows="3"
                                      ...
                                      class="block w-full px-4 py-3 text-sm text-gray-700 placeholder-gray-400 bg-white border border-gray-300 rounded-lg focus:border-purple-400 focus:outline-none focus:ring focus:ring-purple-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:focus:border-purple-300 dark:placeholder-gray-500">{{ $program->full_address ?? '' }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <!-- Waktu Mulai -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" for="start_time">
                            ...
                            <!-- Tanggal Berakhir -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" for="end_date">
                            ...
                            <!-- Waktu Berakhir -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" for="end_time">
                    ...
                    <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="{{ $program->image }}" alt="Current image" class="w-32 h-32 object-cover rounded-lg border border-gray-300 dark:border-gray-600">
                        </div>
                        @endif
