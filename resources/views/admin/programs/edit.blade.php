...
@section('content')
            ...
            <!-- Form Card with Progress Header -->
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select name="category" required x-model="category"
                                            ...
                                            <option value="kursus" {{ old('category', $program->category) == 'kursus' ? 'selected' : '' }}>Kursus
                                            </option>
                                            <option value="pelatihan" {{ old('category', $program->category) == 'pelatihan' ? 'selected' : '' }}>
                                                Pelatihan</option>
                                            <option value="sertifikasi" {{ old('category', $program->category) == 'sertifikasi' ? 'selected' : '' }}>Sertifikasi
                                            </option>
                                            <option value="outing-class" {{ old('category', $program->category) == 'outing-class' ? 'selected' : '' }}>Outing Class
                                            </option>
                                    ...
                                    <div>
                                        ...
                                        <select name="type" required x-model="type"
                                            ...
                                            <option value="online" {{ old('type', $program->type) == 'online' ? 'selected' : '' }}>🌐 Online
                                            </option>
                    ...
                    <div x-show="currentStep === 5" x-transition:enter="transition ease-out duration-300"
                        ...
                        <div class="p-5 sm:p-8">
                            ...
                            <div
                                x-data="{ imagePreview: '{{ $program->image ? asset('storage/' . $program->image) : '' }}' }">
                                <label for="image"
    ...
    <style>
        ...
        @if(isset($locationData) && $program->type === 'offline')
        <script>
