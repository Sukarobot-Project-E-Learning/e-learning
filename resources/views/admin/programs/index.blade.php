...
@section('content')
    <div class="container px-6 mx-auto overflow-x-hidden max-w-full" x-data="programTable()">
        <div class="my-6 flex items-center justify-between">
            ...
            <a href="{{ route('admin.programs.create') }}" data-turbo="false"
            ...
            <div class="flex flex-col md:flex-row gap-4">
                <div class="relative flex-1">
                    ...
                    <input type="text" x-model="search" @input.debounce.300ms="filterTable()"
                        placeholder="Cari program, kategori, jenis..."
                ...
                <select x-model="category" @change="filterTable()"
        ...
        <div class="block lg:hidden space-y-3 mb-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4"
                    ...
                    <div class="flex items-start gap-3">
                        <template x-if="program.image">
                            <img :src="getImageUrl(program.image)"
                                ...
                                @click="window.open(getImageUrl(program.image), '_blank')">
                        </template>
                        <template x-if="!program.image">
                            <div
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="font-semibold text-gray-800 dark:text-white truncate"
                                x-html="highlightText(program.title)"></h3>
                        ...
                        <span
                            class="px-2 py-1 text-xs font-bold rounded-full whitespace-nowrap bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300"
                            x-text="program.type"></span>
                    </div>
                    <div class="mt-3 pt-3 border-t border-gray-100 dark:border-gray-700 flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-2">
                            <a :href="'/admin/programs/' + program.id + '/edit'" data-turbo="false"
            ...
            <template x-if="programs.length === 0">
                <div
                    ...
                    <a href="{{ route('admin.programs.create') }}" data-turbo="false"
                        class="mt-2 inline-block text-orange-600 hover:text-orange-700 font-medium">+ Tambah program
                        baru</a>
                </div>
            </template>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-orange-100 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-orange-50 dark:hover:bg-gray-700 transition-colors duration-150"
                                ...
                                <td class="px-6 py-4">
                                    <div class="font-semibold text-gray-800 dark:text-white"
                                        x-html="highlightText(program.title)"></div>
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-300" x-text="program.category">
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-300" x-text="program.start_date">
                                </td>
                                <td class="px-6 py-4"><span
                                        class="px-2 py-1 text-xs font-bold rounded-full bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300"
                                        x-text="program.type"></span></td>
                                <td class="px-6 py-4 text-sm font-medium text-orange-600" x-text="program.price"></td>
                                <td class="px-6 py-4">
                                    <template x-if="program.image"><img :src="getImageUrl(program.image)"
                                            ...
                                            @click="window.open(getImageUrl(program.image), '_blank')"></template>
                                    <template x-if="!program.image">
                                        <div
                                            class="w-16 h-12 rounded-lg bg-gradient-to-br from-orange-100 to-orange-200 flex items-center justify-center">
                        ...
                        <template x-if="programs.length === 0">
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center text-gray-500"><svg
                                    ...
                                    <p class="text-lg font-medium">Tidak ada program ditemukan</p><a
                                        href="{{ route('admin.programs.create') }}" data-turbo="false"
