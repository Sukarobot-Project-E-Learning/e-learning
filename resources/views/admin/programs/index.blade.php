...
@section('content')
    <div class="container px-6 mx-auto">
        ...
        <div class="my-6">
            ...
            <!-- Filter and Tambah Program Buttons -->
                            ...
                            <ul class="space-y-2.5">
                                <li>
                                    <label class="inline-flex items-center w-full cursor-pointer">
                                        ...
                                        <span class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">Pelatihan</span>
                                    </label>
                                </li>
                                <li>
                                    <label class="inline-flex items-center w-full cursor-pointer">
                                        <input type="checkbox" class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600">
                                        <span class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">Sertifikasi</span>
                                    </label>
                                </li>
                                <li>
                                    <label class="inline-flex items-center w-full cursor-pointer">
                                        <input type="checkbox" class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600">
                                        <span class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">Training</span>
                                    </label>
                                </li>
                            </ul>
