...
@section('content')
    ...
    <div class="container px-6 mx-auto">
        ...
        <div class="my-6">
            <div class="flex items-start justify-between">
                ...
                <div class="flex flex-col items-end" style="gap: 16px;">
                    <a href="{{ route('elearning.admin.admins.index') }}"
        ...
        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-md bg-white dark:bg-gray-800">
            <form id="adminForm" action="{{ route('elearning.admin.admins.update', $admin->id ?? 1) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
