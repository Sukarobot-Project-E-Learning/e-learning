...
@section('content')
    <div class="container px-6 mx-auto">
        ...
        <div class="my-6">
            ...
            <!-- Filter and Tambah Admin Buttons -->
            <div class="flex flex-wrap items-center justify-between gap-3 mt-4">
                ...
                <!-- Tambah Admin Button -->
                <button type="button"
                        onclick="window.location.href='{{ route('elearning.admin.admins.create') }}'"
            ...
            <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        @php
                        $admins = [
                            ['id' => 1, 'name' => 'Nama Admin', 'email' => 'emailadmin@gmail.com', 'phone' => '081234567891', 'photo' => null, 'status' => 'Aktif'],
                            ['id' => 2, 'name' => 'Nama Admin', 'email' => 'emailadmin@gmail.com', 'phone' => '081234567891', 'photo' => null, 'status' => 'Aktif'],
                            ['id' => 3, 'name' => 'Nama Admin', 'email' => 'emailadmin@gmail.com', 'phone' => '081234567891', 'photo' => null, 'status' => 'Aktif'],
                            ['id' => 4, 'name' => 'Nama Admin', 'email' => 'emailadmin@gmail.com', 'phone' => '081234567891', 'photo' => null, 'status' => 'Aktif'],
                            ['id' => 5, 'name' => 'Nama Admin', 'email' => 'emailadmin@gmail.com', 'phone' => '081234567891', 'photo' => null, 'status' => 'Aktif'],
                            ['id' => 6, 'name' => 'Nama Admin', 'email' => 'emailadmin@gmail.com', 'phone' => '081234567891', 'photo' => null, 'status' => 'Aktif'],
                            ['id' => 7, 'name' => 'Nama Admin', 'email' => 'emailadmin@gmail.com', 'phone' => '081234567891', 'photo' => null, 'status' => 'Aktif'],
                        ];
                        @endphp
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center" style="gap: 12px;">
                                    ...
                                    <button class="flex items-center justify-center w-8 h-8 bg-blue-500 text-white rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 transition-colors duration-150" 
                                            aria-label="Edit"
                                            onclick="window.location.href='{{ route('elearning.admin.admins.edit', $admin['id']) }}'">
                                    ...
                                    <form action="{{ route('elearning.admin.admins.destroy', $admin['id']) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus admin ini?');" class="inline-block m-0">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
            ...
            <div class="flex flex-col items-center justify-between px-4 py-4 border-t dark:border-gray-700 bg-gray-50 dark:bg-gray-800 sm:flex-row sm:px-6">
                ...
                <div class="flex items-center mb-4 sm:mb-0">
                    <span class="text-sm text-gray-700 dark:text-gray-400">
                        Showing <span class="font-semibold text-gray-900 dark:text-white">1</span> to <span class="font-semibold text-gray-900 dark:text-white">{{ count($admins) }}</span> of <span class="font-semibold text-gray-900 dark:text-white">100</span> results
                    </span>
                </div>
