        ...
        <div class="block lg:hidden space-y-3 mb-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                    ...
                    <div
                        ...
                        <button @click="deleteAdmin(user.id)"
                            class="px-3 py-1.5 text-sm font-medium text-red-600 hover:bg-red-50 dark:hover:bg-gray-700 rounded-lg transition-colors cursor-pointer">Hapus</button>
                    </div>
                </div>
            </template>
            <template x-if="users.length === 0">
                <div
                    ...
                    <a href="{{ route('admin.admins.create') }}"
                        class="mt-2 inline-block text-orange-600 hover:text-orange-700 font-medium">+ Tambah admin baru</a>
                </div>
            </template>
        </div>
                            ...
                            <tr class="hover:bg-orange-50 dark:hover:bg-gray-700 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <button @click="deleteAdmin(user.id)"
                                            class="p-2 text-red-600 hover:bg-red-100 rounded-lg transition-colors cursor-pointer"><svg
                                                class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <template x-if="users.length === 0">
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center text-gray-500"><svg
                                    ...
                                    <p class="text-lg font-medium">Tidak ada admin ditemukan</p><a
