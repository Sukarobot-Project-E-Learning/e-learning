                        ...
                        <div class="p-4">
                            ...
                            <ul class="space-y-2.5">
                                ...
                                <li>
                                    <label class="inline-flex items-center w-full cursor-pointer">
                                        <input type="checkbox" class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600">
                                        <span class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">Diterima</span>
                                    </label>
                                </li>
                                <li>
                                    <label class="inline-flex items-center w-full cursor-pointer">
                                        <input type="checkbox" class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600">
                                        <span class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">Ditolak</span>
                                    </label>
                                </li>
                            </ul>
            ...
            <div class="w-full px-4 py-4 bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                <div class="relative w-full max-w-xl">
                    ...
                    <input type="text" 
                           ...
                           placeholder="Cari bukti program...">
                </div>
            </div>
            ...
            <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        @php
                        $proofs = [
                            ['id' => 1, 'name' => 'Nama User', 'program_title' => 'Workshop Branding', 'schedule' => '20 September 2025', 'documentation' => null],
                            ['id' => 2, 'name' => 'Nama User', 'program_title' => 'Workshop Branding', 'schedule' => '20 September 2025', 'documentation' => null],
                            ['id' => 3, 'name' => 'Nama User', 'program_title' => 'Workshop Branding', 'schedule' => '20 September 2025', 'documentation' => null],
                            ['id' => 4, 'name' => 'Nama User', 'program_title' => 'Workshop Branding', 'schedule' => '20 September 2025', 'documentation' => null],
                            ['id' => 5, 'name' => 'Nama User', 'program_title' => 'Workshop Branding', 'schedule' => '20 September 2025', 'documentation' => null],
                            ['id' => 6, 'name' => 'Nama User', 'program_title' => 'Workshop Branding', 'schedule' => '20 September 2025', 'documentation' => null],
                            ['id' => 7, 'name' => 'Nama User', 'program_title' => 'Workshop Branding', 'schedule' => '20 September 2025', 'documentation' => null],
                        ];
                        @endphp
            ...
            <div class="flex flex-col items-center justify-between px-4 py-4 border-t dark:border-gray-700 bg-gray-50 dark:bg-gray-800 sm:flex-row sm:px-6">
                ...
                <div class="flex items-center mb-4 sm:mb-0">
                    <span class="text-sm text-gray-700 dark:text-gray-400">
                        Showing <span class="font-semibold text-gray-900 dark:text-white">1</span> to <span class="font-semibold text-gray-900 dark:text-white">{{ count($proofs) }}</span> of <span class="font-semibold text-gray-900 dark:text-white">58</span> results
                    </span>
                </div>
