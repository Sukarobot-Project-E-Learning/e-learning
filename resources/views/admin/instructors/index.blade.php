...
@section('content')
    <div class="container px-6 mx-auto overflow-x-hidden max-w-full" x-data="instructorTable()">
        <div class="my-6 flex items-center justify-between">
            ...
            <a href="{{ route('admin.instructors.create') }}" data-turbo="false"
            ...
            <div class="mt-3 flex flex-wrap items-center justify-between gap-2 text-sm text-gray-500 dark:text-gray-400">
                <div class="flex items-center gap-1">
                    ...
                    <span>dari</span><span class="font-semibold text-orange-600"
                        x-text="total"></span><span>instruktur</span>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                    <div class="flex items-start gap-3">
                        <template x-if="instructor.avatar">
                            <img :src="getAvatarUrl(instructor.avatar)"
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="font-semibold text-gray-800 dark:text-white truncate"
                                x-html="highlightText(instructor.name)"></h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400 truncate"
                                x-html="highlightText(instructor.email || '-')"></p>
                            <p class="text-sm text-gray-500 dark:text-gray-400" x-text="instructor.expertise || '-'"></p>
                        </div>
                        <span
                            :class="instructor.is_active ? 'bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300' : 'bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300'"
                    ...
                    <div
                        ...
                        <a :href="'/admin/instructors/' + instructor.id + '/edit'"
            ...
            <template x-if="instructors.length === 0">
                <div
                    ...
                    <a href="{{ route('admin.instructors.create') }}"
                        class="mt-2 inline-block text-orange-600 hover:text-orange-700 font-medium">+ Tambah instruktur
                        baru</a>
                </div>
            </template>
        </div>
                            ...
                            <tr class="hover:bg-orange-50 dark:hover:bg-gray-700 transition-colors duration-150">
                                <td class="px-6 py-4">
                                    <div class="font-semibold text-gray-800 dark:text-white"
                                        x-html="highlightText(instructor.name)"></div>
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-300"
                                    x-html="highlightText(instructor.email || '-')"></td>
                                <td class="px-6 py-4">
                                    <template x-if="instructor.avatar"><img :src="getAvatarUrl(instructor.avatar)"
                                            ...
                                            style="width: 3rem; height: 3rem; min-width: 3rem; object-fit: cover;"
                                            @click="window.open(getAvatarUrl(instructor.avatar), '_blank')"></template>
                                    <template x-if="!instructor.avatar">
                                        <div
                                            class="w-12 h-12 rounded-full bg-gradient-to-br from-orange-100 to-orange-200 flex items-center justify-center">
                                            <svg class="w-6 h-6 text-orange-400" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <template x-if="instructors.length === 0">
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center text-gray-500">
                                    <p class="text-lg font-medium">Tidak ada instruktur ditemukan</p><a
