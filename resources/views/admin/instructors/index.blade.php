                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        <tr>
                            <td colspan="6" class="px-4 py-8 text-center text-gray-500 dark:text-gray-400">
                                Belum ada instruktur. <a href="{{ route('admin.instructors.create') }}" class="text-purple-600 hover:text-purple-800 dark:text-purple-400">Tambah instruktur pertama</a>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
