...
@section('content')
    <div class="container px-6 mx-auto">
        ...
        <!-- Pending Applications Table (Only if exists) -->
            ...
            <div id="instructors-table" class="w-full mb-8 overflow-hidden rounded-lg shadow-md dark:bg-gray-800">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const tableContainer = document.getElementById('instructors-table');
            ...
            function fetchInstructors() {
                ...
                fetch(`{{ route('admin.instructors.index') }}?search=${search}&status=${status}`, {
                    headers: {
            ...
            searchInput.addEventListener('input', function() {
                ...
                timeoutId = setTimeout(fetchInstructors, 300);
            });
