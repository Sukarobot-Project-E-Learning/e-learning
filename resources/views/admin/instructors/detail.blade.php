    ...
    <div class="container px-6 mx-auto">
        ...
        <div class="my-6">
            <div class="flex items-start justify-between">
                <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200">Detail Instruktur</h2>
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('admin.instructors.edit', $instructor->id) }}"
                       class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-orange-600 border border-transparent rounded-lg hover:bg-orange-700">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-md bg-white dark:bg-gray-800">
            <div class="px-6 py-6 space-y-6">
                ...
                <div class="flex justify-end">
                    ...
                    @else
                        <span class="px-3 py-1 font-semibold leading-tight rounded-full" style="background-color: #f3f4f6; color: #374151;">
                            Tidak Aktif
                        </span>
                    @endif
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center px-4 py-3 text-sm text-gray-700 bg-gray-50 border border-gray-300 rounded-lg dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600">
                                @if($instructor->avatar)
                                    ...
                                    @endphp
                                    <img class="w-10 h-10 rounded-full mr-3 object-cover cursor-pointer border-2 border-orange-200" 
                                         src="{{ $avatarUrl }}" 
                                         alt="Avatar" 
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="px-4 py-3 text-sm text-gray-700 bg-gray-50 border border-gray-300 rounded-lg dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 min-h-[80px]">
                                {{ $instructor->expertise ?? $instructor->skills ?? '-' }}
                            </div>
                        </div>
                        ...
                        <!-- Bio -->
                         <div>
                            ...
                            <div class="px-4 py-3 text-sm text-gray-700 bg-gray-50 border border-gray-300 rounded-lg dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 min-h-[80px] max-h-32 overflow-y-auto">
                                {{ $instructor->bio ?? '-' }}
                            </div>
                        </div>
                    </div>
                ...
                <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <div class="w-full">
                                @if(isset($instructor->cv_path) && $instructor->cv_path)
                                    <div class="flex items-center justify-between p-4 bg-gray-50 border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-600">
                                        ...
                                        <a href="{{ route('admin.instructors.download', ['id' => $instructor->id, 'type' => 'cv']) }}" 
                        ...
                        <div>
                            ...
                            <div class="w-full">
                                @if(isset($instructor->ktp_path) && $instructor->ktp_path)
                                    <div class="flex items-center justify-between p-4 bg-gray-50 border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-600">
                                        <div class="flex items-center">
                                        ...
                                        <a href="{{ route('admin.instructors.download', ['id' => $instructor->id, 'type' => 'ktp']) }}" 
                        ...
                        <div>
                            ...
                            <div class="w-full">
                                @if(isset($instructor->npwp_path) && $instructor->npwp_path)
                                    <div class="flex items-center justify-between p-4 bg-gray-50 border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-600">
                                        <div class="flex items-center">
                                        ...
                                        <a href="{{ route('admin.instructors.download', ['id' => $instructor->id, 'type' => 'npwp']) }}" 
