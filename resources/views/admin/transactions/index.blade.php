...
@section('content')
<div class="container px-6 mx-auto" x-data="transactionTable()">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4" :style="'animation-delay:' + (index * 50) + 'ms'">
                <div class="flex items-start gap-3">
                    <template x-if="transaction.proof">
                        <img :src="transaction.proof" class="w-12 h-12 rounded-lg object-cover border-2 border-orange-200" @click="window.open(transaction.proof, '_blank')">
                    </template>
                    <template x-if="!transaction.proof">
