    ...
    <div class="container px-6 mx-auto">
        ...
        <div class="my-6">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mt-4">
                            ...
                            <ul class="space-y-2.5">
                                <li>
                                    <label class="inline-flex items-center w-full cursor-pointer">
                                        ...
                                        <span class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">Lunas</span>
                                    </label>
                                </li>
                                <li>
                                    <label class="inline-flex items-center w-full cursor-pointer">
                ...
                <!-- Ekspor Excel Button -->
                <a href="{{ route('elearning.admin.transactions.export') }}"
                ...
                <table class="w-full whitespace-no-wrap">
                        ...
                        <tr class="text-xs font-bold tracking-wide text-left text-gray-600 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                            <th class="px-4 py-3 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 select-none" 
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <div class="flex flex-col -my-1 ml-1">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <span class="px-2 py-1 text-xs font-semibold rounded-full {{ $transaction['status'] === 'Lunas' ? 'bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100' : 'bg-yellow-100 text-yellow-800 dark:bg-yellow-800 dark:text-yellow-100' }}">
                                    {{ $transaction['status'] }}
                                </span>
                            </td>
                            <td class="px-4 py-3">
                                <!-- Delete Button (Red Square) -->
                                <form action="{{ route('elearning.admin.transactions.destroy', $transaction['id']) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus transaksi ini?');" class="inline-block m-0">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" 
            ...
            <div class="flex flex-col items-center justify-between px-4 py-4 border-t dark:border-gray-700 bg-gray-50 dark:bg-gray-800 sm:flex-row sm:px-6">
                ...
                <div class="flex items-center mb-4 sm:mb-0">
                    <span class="text-sm text-gray-700 dark:text-gray-400">
                        Showing <span class="font-semibold text-gray-900 dark:text-white">1</span> to <span class="font-semibold text-gray-900 dark:text-white">{{ count($transactions) }}</span> of <span class="font-semibold text-gray-900 dark:text-white">58</span> results
                    </span>
                </div>
