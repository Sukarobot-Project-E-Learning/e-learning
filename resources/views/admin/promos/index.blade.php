...
@section('content')
    ...
    <div class="container px-6 mx-auto">
        ...
        <div class="my-6">
            ...
            <!-- Filter and Tambah Promo Buttons -->
            <div class="flex flex-wrap items-center justify-between gap-3 mt-4">
                ...
                <!-- Tambah Promo Button -->
                <button type="button"
                        onclick="window.location.href='{{ route('elearning.admin.promos.create') }}'"
                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <span class="px-2 py-1 text-xs font-semibold rounded-full {{ $promo['status'] === 'Aktif' ? 'bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100' : 'bg-red-100 text-red-800 dark:bg-red-800 dark:text-red-100' }}">
                                    {{ $promo['status'] }}
                                </span>
                            </td>
                            <td class="px-4 py-3">
                                <div class="flex items-center" style="gap: 12px;">
                                    ...
                                    <a href="{{ route('elearning.admin.promos.edit', $promo['id']) }}"
                                    ...
                                    <form action="{{ route('elearning.admin.promos.destroy', $promo['id']) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus promo ini?');" class="inline-block m-0">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
            ...
            <div class="flex flex-col items-center justify-between px-4 py-4 border-t dark:border-gray-700 bg-gray-50 dark:bg-gray-800 sm:flex-row sm:px-6">
                ...
                <div class="flex items-center mb-4 sm:mb-0">
                    <span class="text-sm text-gray-700 dark:text-gray-400">
                        Showing <span class="font-semibold text-gray-900 dark:text-white">1</span> to <span class="font-semibold text-gray-900 dark:text-white">{{ count($promos) }}</span> of <span class="font-semibold text-gray-900 dark:text-white">58</span> results
                    </span>
                </div>
