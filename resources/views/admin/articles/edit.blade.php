...
@section('content')
    ...
    <div class="container px-6 mx-auto">
        ...
        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-md bg-white dark:bg-gray-800">
            <form id="articleForm" action="{{ route('elearning.admin.articles.update', $article['id']) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="px-6 py-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="10" required
                                  class="block w-full px-4 py-3 text-sm text-gray-700 placeholder-gray-400 bg-white border border-gray-300 rounded-lg focus:border-purple-400 focus:outline-none focus:ring focus:ring-purple-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:focus:border-purple-300 dark:placeholder-gray-500">{{ $article['content'] }}</textarea>
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="image" 
                                   ...
                                   x-data="{ imagePreview: '{{ $article['image'] ?? null }}' }"
                                   @dragover.prevent
                                   @drop.prevent="
