...
@section('content')
    <div class="container px-6 mx-auto">
        ...
        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-md dark:bg-gray-800">
                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">{{ $article['date'] }}</td>
                            <td class="px-4 py-3">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a href="{{ route('admin.articles.edit', $article['id']) }}" class="text-green-600 hover:text-green-800 dark:text-green-400">Edit</a>
                                    <button @click="deleteArticle({{ $article['id'] }})" class="text-red-600 hover:text-red-800 dark:text-red-400">Hapus</button>
                                </div>
                            </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="6" class="px-4 py-8 text-center text-gray-500 dark:text-gray-400">
                                Tidak ada artikel. <a href="{{ route('admin.articles.create') }}" class="text-orange-600 hover:text-orange-800 dark:text-orange-400">Tambah artikel pertama</a>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
            ...
            <!-- Pagination Section -->
            @include('components.pagination', ['items' => $articles ?? null])
        </div>
    </div>
