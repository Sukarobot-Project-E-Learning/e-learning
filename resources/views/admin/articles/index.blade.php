...
@section('content')
    ...
    <div class="container px-6 mx-auto">
        ...
        <div class="my-6">
            <!-- Title -->
            <div class="mb-4">
                <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200">Artikel</h2>
            </div>

            <!-- Filter and Tambah Artikel Buttons -->
            <div class="flex flex-wrap items-center justify-between gap-3 mt-4">
                        ...
                        <div class="p-4">
                            ...
                            <ul class="space-y-2.5">
                                ...
                                <li>
                                    <label class="inline-flex items-center w-full cursor-pointer">
                                        <input type="checkbox" class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600">
                                        <span class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">Draft</span>
                                    </label>
                                </li>
                            </ul>
                ...
                <button type="button"
                        onclick="window.location.href='{{ route('elearning.admin.articles.create') }}'"
                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <span class="px-2 py-1 text-xs font-semibold rounded-full {{ $article['status'] === 'Aktif' ? 'bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100' : 'bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-100' }}">
                                    {{ $article['status'] }}
                                </span>
                            </td>
                            <td class="px-4 py-3">
                                <div class="flex items-center" style="gap: 12px;">
                                    ...
                                    <a href="{{ route('elearning.admin.articles.edit', $article['id']) }}"
                                    ...
                                    <form action="{{ route('elearning.admin.articles.destroy', $article['id']) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus artikel ini?');" class="inline-block m-0">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
            ...
            <div class="flex flex-col items-center justify-between px-4 py-4 border-t dark:border-gray-700 bg-gray-50 dark:bg-gray-800 sm:flex-row sm:px-6">
                ...
                <div class="flex items-center mb-4 sm:mb-0">
                    <span class="text-sm text-gray-700 dark:text-gray-400">
                        Showing <span class="font-semibold text-gray-900 dark:text-white">1</span> to <span class="font-semibold text-gray-900 dark:text-white">{{ count($articles) }}</span> of <span class="font-semibold text-gray-900 dark:text-white">58</span> results
                    </span>
                </div>
