                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <button type="button" @click="addQuestion()"
                                class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-green-600 border border-transparent rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500">
            ...
            function quizForm() {
                return {
                    formData: {
                        ...
                        program_id: {!! json_encode($quiz->program_id) !!},
