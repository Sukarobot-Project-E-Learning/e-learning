                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a href="{{ route('instructor.quizzes.show', $quiz['id']) }}" class="text-blue-600 hover:text-blue-800 dark:text-blue-400">Lihat</a>
                                    <a href="{{ route('instructor.quizzes.edit', $quiz['id']) }}" class="text-green-600 hover:text-green-800 dark:text-green-400">Edit</a>
                        ...
                        <tr>
                            <td colspan="6" class="px-4 py-8 text-center text-gray-500 dark:text-gray-400">
                                Belum ada tugas/postest. <a href="{{ route('instructor.quizzes.create') }}" class="text-purple-600 hover:text-purple-800 dark:text-purple-400">Buat tugas/postest pertama</a>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
