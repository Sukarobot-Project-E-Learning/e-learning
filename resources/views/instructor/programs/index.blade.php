...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-100 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
        <div class="container px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        <div class="text-white max-w-2xl">
                            <p class="text-sm text-blue-100 sm:text-base">
                                Kelola pengajuan program Anda. Program baru memerlukan persetujuan admin sebelum
                                dipublikasikan.
                            </p>
                        </div>
                    ...
                    <div class="grid grid-cols-3 gap-3 mt-8 sm:gap-4">
                        <div class="p-3 sm:p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                            <div class="flex items-center gap-2 sm:gap-3">
                                ...
                                <div>
                                    <p id="stat-pending" class="text-lg sm:text-2xl font-bold text-white">0</p>
                        ...
                        <div class="p-3 sm:p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                            <div class="flex items-center gap-2 sm:gap-3">
                                ...
                                <div>
                                    <p id="stat-approved" class="text-lg sm:text-2xl font-bold text-white">0</p>
                        ...
                        <div class="p-3 sm:p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                            <div class="flex items-center gap-2 sm:gap-3">
                                ...
                                <div>
                                    <p id="stat-rejected" class="text-lg sm:text-2xl font-bold text-white">0</p>
            ...
            <div class="mb-6 p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
                <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div class="relative flex-1 max-w-md">
                        ...
                        <input type="text" id="search-input" placeholder="Cari judul program, kategori..."
                    ...
                    <!-- Filter Buttons -->
                    <div class="flex flex-wrap items-center gap-2" id="status-filter-container">
                        <span class="text-xs font-medium text-gray-500 dark:text-gray-400">Filter:</span>
                        <button data-filter="all" class="status-filter-btn px-3 py-1.5 text-xs font-medium border rounded-lg transition-all duration-200 bg-blue-600 text-white border-blue-600">
                            Semua
                        </button>
                        <button data-filter="pending" class="status-filter-btn px-3 py-1.5 text-xs font-medium border rounded-lg transition-all duration-200 bg-white text-gray-600 border-gray-200 hover:border-yellow-300 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600">
                            Menunggu
                        </button>
                        <button data-filter="approved" class="status-filter-btn px-3 py-1.5 text-xs font-medium border rounded-lg transition-all duration-200 bg-white text-gray-600 border-gray-200 hover:border-green-300 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600">
                            Disetujui
                        </button>
                        <button data-filter="rejected" class="status-filter-btn px-3 py-1.5 text-xs font-medium border rounded-lg transition-all duration-200 bg-white text-gray-600 border-gray-200 hover:border-red-300 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600">
                            Ditolak
                        </button>
                    </div>
                ...
                <div class="flex flex-wrap items-center justify-between gap-2 mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <span id="results-total" class="font-semibold">0</span> program
            ...
            <div class="hidden lg:block mb-8 overflow-hidden bg-white rounded-2xl shadow-sm border border-gray-100 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-750">
                                ...
                                <th class="px-6 py-4 text-left">
                                    <button data-sort="category" class="inline-flex items-center gap-2 text-xs font-semibold tracking-wider text-gray-600 uppercase hover:text-blue-600 dark:text-gray-400 transition-colors">
                                        Kategori
                                        <svg class="w-4 h-4 sort-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                        </svg>
                                ...
                                <th class="px-6 py-4 text-left">
                                    <button data-sort="type" class="inline-flex items-center gap-2 text-xs font-semibold tracking-wider text-gray-600 uppercase hover:text-blue-600 dark:text-gray-400 transition-colors">
                                        Tipe
                                        <svg class="w-4 h-4 sort-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                        </svg>
                ...
                <div id="empty-state-desktop" class="hidden px-6 py-16 text-center">
                    <div class="flex flex-col items-center">
                        ...
                        <h3 class="empty-title text-lg font-semibold text-gray-900 dark:text-white mb-1">Belum ada pengajuan program</h3>
                        <p class="empty-desc text-sm text-gray-500 dark:text-gray-400 mb-4">Mulai dengan mengajukan program pertama Anda</p>
                        <a href="{{ route('instructor.programs.create') }}" class="empty-create-btn inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                            </svg>
                            Ajukan Program Baru
            ...
            <!-- Pagination -->
            <div id="pagination-container" class="hidden flex flex-col sm:flex-row mb-20 lg:mb-0 items-center justify-between gap-4 p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
        ...
        <div id="delete-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div class="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden">
                <div class="p-6">
                    ...
                    <p class="text-sm text-center text-gray-600 dark:text-gray-400 mb-6">
                        Apakah Anda yakin ingin menghapus program "<span id="delete-target-title" class="font-medium text-gray-900 dark:text-white"></span>"? Tindakan ini tidak dapat dibatalkan.
                    </p>
    ...
    <script type="application/json" id="programSubmissionsData">@json($submissions ?? [])</script>

@endsection

@push('scripts')
    <script src="{{ asset('assets/elearning/instructor/js/table-core.js') }}"></script>
    <script src="{{ asset('assets/elearning/instructor/js/programs/index.js') }}"></script>
@endpush