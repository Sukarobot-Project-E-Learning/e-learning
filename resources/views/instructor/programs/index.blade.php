...
@section('content')
    <div x-data="programTable()" x-init="init()"
                        ...
                        <div class="p-3 sm:p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                            <div class="flex items-center gap-2 sm:gap-3">
                                <div class="p-2 bg-yellow-400/20 rounded-lg">
                                    <svg class="w-4 h-4 sm:w-5 sm:h-5 text-yellow-300" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                        ...
                        <div class="p-3 sm:p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                            <div class="flex items-center gap-2 sm:gap-3">
                                <div class="p-2 bg-red-400/20 rounded-lg">
                                    <svg class="w-4 h-4 sm:w-5 sm:h-5 text-red-300" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div
                ...
                <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <button @click="statusFilter = 'pending'; filterData()"
                        ...
                        <button @click="statusFilter = 'approved'; filterData()"
                        ...
                        <button @click="statusFilter = 'rejected'; filterData()"
                ...
                <div
                    ...
                    <div x-show="searchQuery.length > 0 || statusFilter !== 'all'" class="flex items-center gap-2">
                        <button @click="searchQuery = ''; statusFilter = 'all'; filterData()"
                            ...
                            <tr class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-750">
                                <th class="px-6 py-4 text-left">
                                    <button @click="sortBy('title')"
                                        ...
                                        <svg class="w-4 h-4 sort-icon"
                                            :class="{'asc': sortColumn === 'title' && sortDirection === 'asc'}" fill="none"
                                ...
                                <th class="px-6 py-4 text-left">
                                    <button @click="sortBy('type')"
                                        ...
                                        Tipe
                                        <svg class="w-4 h-4 sort-icon"
                                            :class="{'asc': sortColumn === 'type' && sortDirection === 'asc'}" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M19 9l-7 7-7-7"></path>
                                        </svg>
                                ...
                                <tr
                                        ...
                                        <div class="flex items-center gap-3">
                                            <div
                                                ...
                                                <span class="text-sm font-bold text-white"
                                                    x-text="submission.title.charAt(0).toUpperCase()"></span>
                                            </div>
                                            <div class="min-w-0 flex-1">
                                                <p class="font-semibold text-gray-900 dark:text-white truncate"
                                                    x-html="highlightSearch(submission.title)"></p>
                                                <p x-show="submission.rejection_reason"
                                                    class="text-xs text-red-500 mt-1 truncate"
                                                    x-text="'Alasan: ' + submission.rejection_reason"></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <span
                                            ...
                                            <svg x-show="submission.type === 'offline'" class="w-3.5 h-3.5" fill="none"
                                                stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            <svg x-show="submission.type === 'video'" class="w-3.5 h-3.5" fill="none"
                                                stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            <span
                                                x-text="submission.type ? submission.type.charAt(0).toUpperCase() + submission.type.slice(1) : '-'"></span>
                                        </span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-600 dark:text-gray-400">
                                            <p x-text="formatDate(submission.created_at)"></p>
                                            <p class="text-xs text-gray-400" x-text="formatTimeAgo(submission.created_at)">
                                            </p>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <template x-if="submission.status !== 'approved'">
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <button @click="confirmDelete(submission)"
                                    ...
                                    <td colspan="6" class="px-6 py-16 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-1"
                                                x-text="searchQuery ? 'Tidak ada hasil ditemukan' : 'Belum ada pengajuan program'">
                                            </h3>
                                            <p class="text-sm text-gray-500 dark:text-gray-400 mb-4"
                                                x-text="searchQuery ? 'Coba kata kunci lain atau hapus filter' : 'Mulai dengan mengajukan program pertama Anda'">
                                            </p>
                                            <a x-show="!searchQuery" href="{{ route('instructor.programs.create') }}"
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-start justify-between gap-3 mb-3">
                                <div class="flex items-center gap-3 min-w-0 flex-1">
                                    <div
                                        class="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20">
                                        <span class="text-lg font-bold text-white"
                                            x-text="submission.title.charAt(0).toUpperCase()"></span>
                                    </div>
                                    <div class="min-w-0 flex-1">
                                        <h3 class="font-semibold text-gray-900 dark:text-white truncate"
                                            x-html="highlightSearch(submission.title)"></h3>
                                        <p class="text-xs text-gray-500 dark:text-gray-400"
                                            x-text="formatDate(submission.created_at) + ' • ' + formatTimeAgo(submission.created_at)">
                                        </p>
                                    </div>
                                </div>
                                <span
                            ...
                            <!-- Rejection Reason -->
                            <div x-show="submission.rejection_reason"
                                class="mb-3 p-2.5 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-100 dark:border-red-900/30">
                                <p class="text-xs text-red-600 dark:text-red-400">
                                    <span class="font-medium">Alasan ditolak:</span> <span
                                        x-text="submission.rejection_reason"></span>
                                </p>
                            </div>
                            ...
                            <div class="flex flex-wrap items-center gap-2 mb-4">
                                <span
                                    class="inline-flex items-center px-2.5 py-1 text-xs font-medium text-gray-600 bg-gray-100 rounded-lg dark:bg-gray-700 dark:text-gray-300"
                                    x-html="highlightSearch(submission.category || '-')"></span>
                                <span class="inline-flex items-center gap-1 px-2.5 py-1 text-xs font-medium rounded-lg"
                                    ...
                                    <svg x-show="submission.type === 'offline'" class="w-3 h-3" fill="none"
                                        stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z">
                                        </path>
                                    </svg>
                                    <svg x-show="submission.type === 'video'" class="w-3 h-3" fill="none"
                                        stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z">
                                        </path>
                ...
                <template x-if="paginatedData.length === 0 && !loading">
                    <div
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-1"
                                x-text="searchQuery ? 'Tidak ada hasil ditemukan' : 'Belum ada pengajuan program'"></h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400 mb-4"
                                x-text="searchQuery ? 'Coba kata kunci lain atau hapus filter' : 'Mulai dengan mengajukan program pertama Anda'">
                            </p>
                        </div>
            ...
            <div x-show="showDeleteModal" x-cloak style="display: none;"
                ...
                <div class="p-6">
                    ...
                    <p class="text-sm text-center text-gray-600 dark:text-gray-400 mb-6">
                        Apakah Anda yakin ingin menghapus program "<span class="font-medium text-gray-900 dark:text-white"
