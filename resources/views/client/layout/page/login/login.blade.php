...
@section('css')
<link rel="stylesheet" href="{{ asset('assets/elearning/client/css/login.css') }}">
@endsection
...
<main class="flex items-center justify-center min-h-screen bg-white">
    <div id="login-card"
      ...
      <div class="w-full md:w-1/2 p-8 flex flex-col justify-center relative">
        ...
        <!-- Error Messages -->
        <div id="error-messages" class="hidden bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-xl relative mb-4" role="alert">
...
<script src="{{ asset('assets/elearning/client/js/login.js') }}"></script>
@endsection
