...
@section('body')
    <div class="container mx-auto px-6 py-12 mt-16">
        <div class="max-w-4xl mx-auto">
            <h2 class="text-3xl font-bold text-gray-900 mb-2">Menjadi Instruktur</h2>
            <p class="text-gray-600 mb-8">Bergabunglah dengan Sukarobot Academy dan bagikan ilmu Anda kepada ribuan siswa.</p>
            ...
            @if(isset($existingApplication) && $existingApplication->status == 'pending')
                <div class="flex flex-col items-center justify-center py-12 text-center bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
