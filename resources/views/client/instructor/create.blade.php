...
@section('title', 'Menjadi Instruktur')

@section('body')
<div class="container py-12 px-6 mx-auto pt-24">
    <div class="max-w-3xl mx-auto">
        <h2 class="text-2xl font-bold text-gray-900 mb-8">Pengajuan Menjadi Instruktur</h2>
        ...
        <form action="{{ route('client.become-instructor.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="skills" id="skills"
                    class="w-full rounded-xl border-gray-200 shadow-sm focus:border-orange-500 focus:ring-orange-500 py-3 px-4 text-gray-700 placeholder-gray-400"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center transition-colors group-hover:border-orange-400 bg-white">
                            <div class="mb-3">
            ...
            <button type="submit" 
                class="w-full bg-orange-500 hover:bg-orange-600 text-white font-semibold py-4 px-6 rounded-xl transition duration-200 flex items-center justify-center gap-2 mt-8">
