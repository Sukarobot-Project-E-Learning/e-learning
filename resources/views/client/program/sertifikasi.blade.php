...
@section('body')
    ...
    <div class="bg-white border-t border-gray-200 sticky top-0 z-30 mt-25">
        <div class="container mx-auto px-6 relative group">
            ...
            <div class="flex justify-start md:justify-center items-center gap-8 md:gap-12 overflow-x-auto py-4 scrollbar-hide scroll-smooth px-8" id="program-nav">
                ...
                <a href="{{ url('/program/sertifikasi') }}" class="nav-item text-sm font-semibold text-blue-600 border-b-2 border-blue-600 pb-1 whitespace-nowrap transition-colors cursor-pointer text-xl flex-shrink-0">Sertifikasi</a>
    ...
    <div class="bg-white py-10 text-center">
        <h1 id="hero-title" class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Dapatkan pengakuan profesional <br> melalui program sertifikasi berstandar industri.</h1>
