    ...
    <div class="bg-white border-t border-gray-200 sticky top-0 z-30 mt-24">
        <div class="container mx-auto px-6 relative group">
            ...
            <div class="flex justify-start md:justify-center items-center gap-8 md:gap-12 overflow-x-auto py-4 scrollbar-hide scroll-smooth px-8" id="program-nav">
                ...
                <a href="{{ url('/program/sertifikasi') }}" class="nav-item text-sm font-bold text-blue-600 border-b-2 border-blue-600 pb-1 whitespace-nowrap transition-colors cursor-pointer text-lg flex-shrink-0">Sertifikasi</a>
    ...
    <section class="py-16 bg-gradient-to-br from-blue-50 via-white to-orange-50 relative overflow-hidden text-center">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-6">
            <h1 id="hero-title" class="text-3xl md:text-5xl font-extrabold text-gray-900 mb-6 leading-tight">
                Dapatkan pengakuan profesional melalui <br> <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-orange-500">Program Sertifikasi</span>
            </h1>
            <p class="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
                Validasi keahlian Anda dengan sertifikat berstandar industri nasional dan internasional.
            </p>
            ...
            <a href="{{ url('program/detail-program') }}" class="block group kelas-card" data-category="sertifikasi" data-date="2023-11-20" data-slots="14">
                <article class="h-full flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-100">
                    <div class="relative overflow-hidden">
                        <img src="https://picsum.photos/400/250?random=3" class="w-full h-52 object-cover transform group-hover:scale-105 transition duration-500" alt="Course Image">
                         <div class="absolute top-3 left-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-purple-600 z-20 shadow-sm">
                            Sertifikasi
                        </div>
                    </div>
                    <div class="p-6 flex flex-col flex-grow">
                        <div class="flex items-center gap-1 mb-3">
                            ...
                            <span class="text-xs text-gray-500">(200 Review)</span>
                        </div>

                        <h3 class="text-xl font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-blue-600 transition-colors">Workshop Branding</h3>
                        
                        <p class="text-gray-600 text-sm mb-5 line-clamp-2 leading-relaxed">Kuasai teknik branding yang kuat untuk membangun identitas produk yang tak terlupakan.</p>
                        ...
                        <div class="mt-auto pt-5 border-t border-gray-100 flex justify-between items-center">
                            ...
                            <span class="text-lg font-bold text-orange-500">Rp 75.000</span>
                        </div>
                    </div>
                </article>
            </a>
...
<script>
    window.activeCategory = "sertifikasi";
</script>
