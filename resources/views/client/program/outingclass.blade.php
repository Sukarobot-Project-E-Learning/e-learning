    ...
    <div class="bg-white border-t border-gray-200 sticky top-0 z-30 mt-24">
        <div class="container mx-auto px-6 relative group">
            ...
            <div class="flex justify-start md:justify-center items-center gap-8 md:gap-12 overflow-x-auto py-4 scrollbar-hide scroll-smooth px-8" id="program-nav">
                ...
                <a href="{{ url('/program/outing-class') }}" class="nav-item text-sm font-bold text-blue-600 border-b-2 border-blue-600 pb-1 whitespace-nowrap transition-colors cursor-pointer text-lg flex-shrink-0">Outing Class</a>
    ...
    <section class="py-16 bg-gradient-to-br from-blue-50 via-white to-orange-50 relative overflow-hidden text-center">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-6">
            <h1 id="hero-title" class="text-3xl md:text-5xl font-extrabold text-gray-900 mb-6 leading-tight">
                Belajar di luar kelas dengan <br> <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-orange-500">Pengalaman Langsung</span>
            </h1>
            <p class="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
                Kegiatan edukatif yang menyenangkan dan interaktif untuk semua usia.
            </p>
    ...
    <div class="container mx-auto px-6 mb-8 mt-8">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4 border-b border-gray-100 pb-6">
            ...
            <div class="text-gray-600 font-medium jumlah-kelas flex items-center gap-2">
                ...
                Menampilkan program Outing Class
            </div>
            ...
            <a href="{{ url('program/detail-program') }}" class="block group kelas-card" data-category="outingclass" data-date="2023-12-01" data-slots="28">
                <article class="h-full flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-100">
                    <div class="relative overflow-hidden">
                        <img src="https://picsum.photos/400/250?random=4" class="w-full h-52 object-cover transform group-hover:scale-105 transition duration-500" alt="Course Image">
                         <div class="absolute top-3 left-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-green-600 z-20 shadow-sm">
                            Outing Class
                        </div>
                    </div>
                    <div class="p-6 flex flex-col flex-grow">
                        <div class="flex items-center gap-1 mb-3">
                            ...
                            <span class="text-xs text-gray-500">(50 Review)</span>
                        </div>

                        <h3 class="text-xl font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-blue-600 transition-colors">Next Level Digital Skill</h3>
                        
                        <p class="text-gray-600 text-sm mb-5 line-clamp-2 leading-relaxed">Tingkatkan keahlian digital Anda ke level berikutnya dengan materi praktik langsung.</p>
...
<script>
    window.activeCategory = "outingclass";
</script>
