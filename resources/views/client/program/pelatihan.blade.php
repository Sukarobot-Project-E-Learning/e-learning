    ...
    <div class="bg-white border-t border-gray-200 sticky top-0 z-30 mt-24">
        <div class="container mx-auto px-6 relative group">
            ...
            <div class="flex justify-start md:justify-center items-center gap-8 md:gap-12 overflow-x-auto py-4 scrollbar-hide scroll-smooth px-8" id="program-nav">
                ...
                <a href="{{ url('/program/pelatihan') }}" class="nav-item text-sm font-bold text-blue-600 border-b-2 border-blue-600 pb-1 whitespace-nowrap transition-colors cursor-pointer text-lg flex-shrink-0">Pelatihan</a>
    ...
    <section class="py-16 bg-gradient-to-br from-blue-50 via-white to-orange-50 relative overflow-hidden text-center">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-6">
            <h1 id="hero-title" class="text-3xl md:text-5xl font-extrabold text-gray-900 mb-6 leading-tight">
                Ikuti pelatihan praktis untuk <br> <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-orange-500">Mengasah Keterampilan</span>
            </h1>
            <p class="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
                Tingkatkan soft skill dan hard skill Anda untuk dunia kerja.
            </p>
    ...
    <div class="container mx-auto px-6 pb-20">
        <div class="kelas-container grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            ...
            <a href="{{ url('program/detail-program') }}" class="block group kelas-card" data-category="pelatihan" data-date="2023-09-15" data-slots="0">
                <article class="h-full flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-100 grayscale opacity-80 hover:opacity-100">
                    <div class="relative overflow-hidden">
                        <img src="https://picsum.photos/400/250?random=2" class="w-full h-52 object-cover transform group-hover:scale-105 transition duration-500" alt="Course Image">
                        <div class="absolute inset-0 bg-black/50 flex items-center justify-center z-20">
                            <span class="bg-red-600 text-white text-xs font-bold px-4 py-2 rounded-full uppercase tracking-wider shadow-lg">Kuota Habis</span>
                        </div>
                         <div class="absolute top-3 left-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-gray-600 z-10 shadow-sm">
                            Pelatihan
                        </div>
                    </div>
                    <div class="p-6 flex flex-col flex-grow">
                        <div class="flex items-center gap-1 mb-3">
                            ...
                            <span class="text-xs text-gray-500">(85 Review)</span>
                        </div>

                        <h3 class="text-xl font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-blue-600 transition-colors">Mental Tangguh di Dunia Kerja</h3>
                        
                        <p class="text-gray-600 text-sm mb-5 line-clamp-2 leading-relaxed">Bangun mentalitas juara dan ketahanan diri untuk menghadapi tantangan di dunia profesional.</p>
                        ...
                        <div class="flex items-center gap-4 text-sm text-gray-500 mb-6">
                            ...
                            <div class="flex items-center gap-1.5">
                                ...
                                <span class="text-red-500 font-bold">0 Slot</span>
                            </div>
                        </div>
