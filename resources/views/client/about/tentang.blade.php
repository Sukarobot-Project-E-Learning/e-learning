      ...
      <div id="tentang-kami" class="content-section">
        ...
        <div class="prose prose-lg max-w-none text-gray-600 leading-relaxed">
            ...
            <div class="my-8 relative rounded-2xl overflow-hidden shadow-lg group">
              <img src="{{ asset('assets/elearning/client/img/Sukarobot-logo.png') }}" alt="Foto Tentang Kami" class="w-full h-64 object-cover transform group-hover:scale-105 transition duration-700"
