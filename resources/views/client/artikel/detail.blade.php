      ...
      <div class="mt-16 pt-8 border-t border-gray-100">
        ...
        <div class="flex flex-wrap gap-3">
          ...
          <a href="https://twitter.com/intent/tweet?url={{ urlencode(request()->url()) }}&text={{ urlencode($article->title) }}" 
             target="_blank"
             class="inline-flex items-center px-5 py-2.5 bg-black text-white rounded-xl font-medium hover:bg-gray-800 transition-all hover:-translate-y-0.5 shadow-sm">
          ...
          <button onclick="copyToClipboard('{{ request()->url() }}')" 
                  class="inline-flex items-center px-5 py-2.5 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white rounded-xl font-medium hover:opacity-90 transition-all hover:-translate-y-0.5 shadow-sm">
    ...
    function copyToClipboard(text) {
        navigator.clipboard.writeText(text).then(() => {
            Swal.fire({
                icon: 'success',
                title: 'Link Disalin!',
                text: 'Silahkan bagikan di Instagram Story atau Post',
            ...
            Swal.fire({
                ...
                text: 'Silahkan salin link secara manual',
            });
        });
    }
</script>
