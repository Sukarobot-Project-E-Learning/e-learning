    ...
    <div class="flex items-center justify-between h-16 px-6">
        ...
        <div class="hidden md:block relative" @mouseenter="profileOpen = true" @mouseleave="profileOpen = false">
            ...
            <button
                ...
                {{-- Avatar --}}
                <div class="relative">
                    <div class="w-10 h-10 rounded-full bg-gradient-to-br {{ $avatarGradient }} p-0.5 shadow-lg">
            ...
            <div x-show="profileOpen" x-cloak x-transition:enter="transition ease-out duration-200"
                ...
                <div class="px-5 py-4 bg-gradient-to-r {{ $headerGradient }}">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-bold text-white">{{ $user->name ?? $role }}</p>
                ...
                <div class="py-2">
                    <a href="{{ $role === 'admin' ? route('admin.admins.edit', $user->id) : route('client.dashboard') }}"
                        ...
                        <div
                            ...
                            <svg class="w-4 h-4 text-slate-500 dark:text-gray-400 {{ $role === 'admin' ? 'group-hover:text-orange-600' : 'group-hover:text-blue-700' }} dark:group-hover:text-blue-400"
                ...
                <div class="border-t border-slate-100 dark:border-gray-700">
                    <form method="POST" action="{{ route('logout') }}" data-turbo="false">
                        ...
                        <button type="submit"
                            ...
                            <div
                                class="w-8 h-8 rounded-lg bg-red-50 dark:bg-red-900/30 flex items-center justify-center mr-3 group-hover:bg-red-100 dark:group-hover:bg-red-900/50 transition-colors">
