<div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl shadow-gray-200/50 dark:shadow-none overflow-hidden" id="assignment-app">
    <div class="px-5 sm:px-8 py-6 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
        ...
        <button id="addAssignmentBtn" type="button" onclick="openAssignmentModal()" class="hidden bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-xl text-sm font-medium transition-colors focus:ring-4 focus:ring-indigo-200">
        ...
        <div id="assignmentForm">
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="assignment_title" class="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:ring-2 focus:ring-indigo-500 transition-colors" placeholder="Tugas Akhir: Membuat Prototype">
                </div>
                ...
                <div>
                    ...
                    <textarea id="assignment_description" rows="5" class="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:ring-2 focus:ring-indigo-500 transition-colors" placeholder="Jelaskan secara detail apa yang harus dilakukan peserta..."></textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="assignment_allowed_extensions" class="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:ring-2 focus:ring-indigo-500 transition-colors" placeholder="pdf, zip, docx" value="pdf, zip, rar">
                    ...
                    <div>
                        ...
                        <input type="date" id="assignment_due_date" class="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:ring-2 focus:ring-indigo-500 transition-colors">
                    </div>
                </div>
            </div>
            <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 flex justify-end gap-3">
                ...
                <button type="button" onclick="submitAssignment(event)" class="px-5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors text-sm font-medium">Simpan Post-Test</button>
            </div>
        </div>
    </div>
</div>
        ...
        if (assignmentsArray.length === 0) {
            container.innerHTML = `
                <div class="text-center py-12 bg-white dark:bg-gray-800 rounded-2xl border border-dashed border-gray-300 dark:border-gray-600">
                    ...
                    <button type="button" onclick="openAssignmentModal()" class="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2.5 rounded-xl text-sm font-medium transition-colors">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-5 group">
                <div class="flex justify-between items-start mb-4">
                    ...
                    <div class="flex gap-2">
                        <button type="button" onclick="editAssignment('${asg.id}')" class="p-2 text-gray-400 hover:text-blue-500 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-colors">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button type="button" onclick="deleteAssignment('${asg.id}')" class="p-2 text-gray-400 hover:text-red-500 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/30 transition-colors">
