            ...
            <div class="p-5 sm:p-8">
                ...
                <div class="space-y-6">
                    ...
                    <div id="imageUploadArea" 
                        ...
                        <input type="file" name="image" id="input-image" accept=".png,.jpg,.jpeg" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer">
                    ...
                    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-blue-700 dark:text-blue-300 mb-2">Ketentuan Gambar Program</p>
                                <ul class="space-y-1 text-sm text-blue-600 dark:text-blue-400">
                                    <li class="flex items-center gap-2">
                                        ...
                                        <span><strong>Format:</strong> .png, .jpg, .jpeg</span>
                                    </li>
                                    <li class="flex items-center gap-2">
                                        <span class="w-1.5 h-1.5 bg-blue-400 rounded-full shrink-0"></span>
                                        <span><strong>Ukuran:</strong> 1920 x 1080 piksel (landscape)</span>
                                    </li>
                                    <li class="flex items-center gap-2">
                                        <span class="w-1.5 h-1.5 bg-blue-400 rounded-full shrink-0"></span>
                                        <span><strong>Ukuran file:</strong> Maksimal 2MB</span>
                                    </li>
                                    <li class="flex items-center gap-2">
                                        <span class="w-1.5 h-1.5 bg-blue-400 rounded-full shrink-0"></span>
                                        <span><strong>Fokus konten</strong> di tengah gambar</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="sticky bottom-0 px-5 sm:px-8 py-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between gap-4">
                ...
                <button type="submit" id="submitBtn" class="hidden items-center gap-2 px-6 py-2.5 bg-green-600 hover:bg-green-700 text-white rounded-xl transition-colors font-medium">
                    ...
                    {{ $isEdit ? 'Simpan Perubahan' : ($isAdmin ? 'Simpan Program' : 'Ajukan Program') }}
                </button>
            </div>
        </div>
    </form>
