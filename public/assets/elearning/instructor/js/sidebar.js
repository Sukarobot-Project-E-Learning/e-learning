/**
 * Instructor Sidebar Component Script
 * Handles collapsible menu sections, mobile sidebar overlay, and state persistence.
 * Instructor-specific version.
 */

document.addEventListener("DOMContentLoaded", function () {
    console.log("[Instructor Sidebar] Script initialized");
    ...
    const CONFIG = {
        ...
        // Storage
        storageKey: 'instructor_sidebar_expanded_items',
        // Animation
    ...
    console.log("[Instructor Sidebar] Elements found:", {
    ...
    function loadExpandedState() {
        try {
            ...
            console.warn("[Instructor Sidebar] Failed to load sidebar state from localStorage:", e);
        }
    }
    ...
    function saveExpandedState() {
        try {
            ...
            console.warn("[Instructor Sidebar] Failed to save sidebar state to localStorage:", e);
        }
    }
    ...
    function initExpandableSection(button, itemId) {
        ...
        if (!content || !content.classList.contains(CONFIG.expandableContentClass)) {
            console.warn("[Instructor Sidebar] Expandable content not found for button:", button);
            return;
        }
    ...
    function initExpandableSections(container) {
        ...
        console.log("[Instructor Sidebar] Found", expandBtns.length, "expandable buttons in container");
    ...
    function openMobileSidebar() {
        ...
        console.log("[Instructor Sidebar] Mobile sidebar opened");
    }
    ...
    function closeMobileSidebar() {
        ...
        console.log("[Instructor Sidebar] Mobile sidebar closed");
    }
    ...
    if (desktopSidebar) {
        console.log("[Instructor Sidebar] Initializing desktop sidebar");
        initExpandableSections(desktopSidebar);
    }

    // Initialize mobile sidebar expandable sections
    if (mobileSidebar) {
        console.log("[Instructor Sidebar] Initializing mobile sidebar");
    ...
    document.addEventListener('toggle-mobile-sidebar', function () {
        console.log("[Instructor Sidebar] Received toggle-mobile-sidebar event");
        toggleMobileSidebar();
    });
    ...
    console.log("[Instructor Sidebar] Initialization complete");
});
